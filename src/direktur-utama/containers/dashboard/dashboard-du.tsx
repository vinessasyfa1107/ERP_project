...
const DashboardDU: Component = () => {
    ...
    return (
        ...
        <div class="header font-[Exo]">
            ...
            <div class="selection">
                <A href='/dashboard-du/report' classList={{ active: location.pathname === '/dashboard-du/report' }}>
                    <div class="box-menu">
            ...
            <div class="selection">
                <A href='/dashboard-du/planning' classList={{ active: location.pathname === '/dashboard-du/planning' }}>
                    <div class="menu-selection">                
            ...
            <div class="selection">
                <A href='/dashboard-du/time-tracking' classList={{ active: location.pathname === '/dashboard-du/time-tracking' }}>
            ...
            <div class="selection">
                <A href='/dashboard-du/kas-approval' classList={{ active: location.pathname === '/dashboard-du/kas-approval' }}>
                    <div class="menu-selection">                
            ...
            <div class="selection">
                <A href='/dashboard-du/keuangan_dashboard' cl-duassList={{ active: location.pathname === '/dashboard-du/keuangan_dashboard' }}>
                    <div class="menu-selection">                
