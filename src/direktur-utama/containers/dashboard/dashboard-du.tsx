...
import './dashboard-du.css';
import { useStore } from "../../../store";
import { useNavbarStore } from "../../../store/Navbar/NavbarStore";


const DashboardDU: Component = () => {
    ...
    return (
        ...
        <div class="header font-[Exo]">
            ...
            <div class="selection">
                <A href='/direktur-utama/dashboard/report' classList={{ active: location.pathname === '/direktur-utama/dashboard/report' }}>
                    <div class="box-menu">
            ...
            <div class="selection">
                <A href='/direktur-utama/dashboard/planning' classList={{ active: location.pathname === '/direktur-utama/dashboard/planning' }}>
                    <div class="menu-selection">                
            ...
            <div class="selection">
                <A href='/direktur-utama/dashboard/time-tracking' classList={{ active: location.pathname === '/direktur-utama/dashboard/time-tracking' }}>
            ...
            <div class="selection">
                <A href='/direktur-utama/dashboard/kas-approval' classList={{ active: location.pathname === '/direktur-utama/dashboard/kas-approval' }}>
                    <div class="menu-selection">                
            ...
            <div class="selection">
                <A href='/direktur-utama/dashboard/keuangan' classList={{ active: location.pathname === '/direktur-utama/dashboard/keuangan' }}>
                    <div class="menu-selection">                
