...
import { api_grafik_keuangan } from '../../../api/keuangan/api_grafik_keuangan';

const Grafik_keuangan2: Component = () => {

    // const [GrafikKeuanganData, setGrafikKeuanganData] = createSignal([]);
    // onMount(async () => {
    //     const func_grafikkeuangan = await api_grafik_keuangan("hallo");
    //     console.log("peng", func_grafikkeuangan);
    //     setGrafikKeuanganData(func_grafikkeuangan);
    // })
    ...
    return (
        <div>
            <div class="grafik-keuangan-container" style={{ "background-color": "#FFFFFFEB", "margin-top": "10px", "border-radius": "6px", "height": "58vh" }}>
                <div id="chartdiv2" style={{ "width": "85vw", "height": "90vw", "font-size": "14px" }}>
                </div>
            </div>
...
export default Grafik_keuangan2;
