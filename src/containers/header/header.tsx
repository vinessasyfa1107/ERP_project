        ...
        <div class="header">
            ...
            <div class="selection">
                <A href='/dashboard/planning' classList={{ active: location.pathname === '/dashboard/planning' }}>
                    <div class="menu-selection">                
                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 34 27" fill="none">
            ...
            <div class="selection">
                <A href='/dashboard/time-tracking' classList={{ active: location.pathname === '/dashboard/time-tracking' }}>
                    <div class="menu-selection" style={{"margin-right": "-1.5vw"}}>                
                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 33 34" fill="none">
            ...
            <div class="selection">
                <A href='/dashboard/arus-kas' classList={{ active: location.pathname === '' }}>
                    <div class="menu-selection">                
                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" width="50" height="45" viewBox="0 0 35 35" fill="none">
            ...
            <div class="selection">
                <A href='/dashboard/admin' classList={{ active: location.pathname === '/dashboard/admin' }}>
                    <div class="menu-selection">                
                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 33 33" fill="none">
