...
import './confirm-all-plan-event.css'
import AgGridSolid from 'ag-grid-solid';
import 'ag-grid-community/styles/ag-grid.css';
import 'ag-grid-community/styles/ag-theme-alpine.css';
import { RowData } from './pengajuan-event-detail';

interface ConfirmAllPlanEventProps {
    OnClose: () => void;
...
const ConfirmAllPlanEvent: Component<ConfirmAllPlanEventProps> = (props) => {
...
export default ConfirmAllPlanEvent;