...
const Barchart_inex_report2: Component = () => {
    createEffect(() => {
    ...
    return (
        <div>
            <div class="barchart1-container" style={{ "background-color": "#FFFFFFEB", "margin-top": "5rem", "border-radius": "6px", "height": "58vh", "margin-left": "-20px", "width": "142vh" }}>
...
export default Barchart_inex_report2;
